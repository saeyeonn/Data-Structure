...
public class ProcessAlgebraicExpression {
        ...
        for (int i = 0 ; isBalanced && i < charCount ; i++) {
			...
			case ')': case ']': case '}' :
				...
				// of the next character and the top of the stack
                    ...
                    isBalanced = isPaired(parenStack.pop(), nextCharacter);
                }
				break;
			}
		}
	...
	public static void main(String[] arg) {
        ...
        if(pae.checkBalance(s)) {
            ...
            System.out.println("balance is cracked");
        }
		...
		System.out.println("The result of [3 * {5 + (15 - 7) / 2 - 9} + 1] ^ 2 is " +
                pae.evaluateInfix("[3 * {5 + (15 - 7) / 2 - 9} +1]^2"));
	}
}